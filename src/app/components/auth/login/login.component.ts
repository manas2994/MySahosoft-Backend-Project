...
import { MustMatchValidator } from 'src/app/validations/validation.validator';
...
export class LoginComponent implements OnInit {
  ...
  constructor(private _fb: FormBuilder,private _toastr:ToastrService,private _commonService:CommonService,private _authService :AuthService) {
  ...
  setRegisterForm() {
    this.registerForm = this._fb.group({
      ...
      firstName: ['', Validators.compose([Validators.required,Validators.maxLength(8),Validators.minLength(3)])],
      lastName: ['', Validators.compose([Validators.required,Validators.maxLength(8),Validators.minLength(3)])],
...
this._toastr.error("username is required!!","Login");
    ...
    {
      console.log("username is required","Login");
